...
int main() {
	...
	auto it21 = M1.find(21); //Notice that find is a member function for map
	//it is not member funciton for list and vector
	...
	/*
	See the following for mre examples and explanations of erase function for list
	http://www.cplusplus.com/reference/list/list/erase/
	
	See the following for more examples and explanations of erase function for map
