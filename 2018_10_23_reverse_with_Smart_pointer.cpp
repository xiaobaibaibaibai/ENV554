//reverse function demonstrates a major challege in using smart pointers.
//CIS554 HW1
...
void doubly_linked_list::reverse() {
	...
	while (p1) {
		//shared_ptr<node> p3; error!
		p2 = p1->next;
		//p3 = p1;//wrong
		p1->next = (p1->previous).lock();
		p1->previous = p2;
		p3 = p1; //this is correct
		//Without introducing p3,
		//during a short period of time,
		//node will only be pointed by
		//weak pointer (i.e., previous)
		//and will be deleted by system
		p1 = p2;
	}
	p2 = head;
	head = tail;
